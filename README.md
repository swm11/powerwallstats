...
'''test_powerwallstats.py''' provides a simple example use case.  You
will need need to setup customer email and password information on
your Powerwall: follow the [Tesla
documentation](https://www.tesla.com/en_gb/support/energy/powerwall/own/monitoring-from-home-network)
to do this.
...
Details of the Tesla gateway API have been reverse engineered and
